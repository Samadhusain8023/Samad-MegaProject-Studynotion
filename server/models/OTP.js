...
const otpTemplateSalman = require("../mail/templates/emailVerificationTemplate"); 
...
{
    try{
        const mailResponse = await mailSender(email,"Verification email from studynotion", otpTemplateSalman(otp) );
