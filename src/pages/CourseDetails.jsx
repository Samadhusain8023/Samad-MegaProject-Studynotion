...
function CourseDetails(){
    ...
    useEffect(() => {
      if (!courseData?.data?.ratingAndReview) return;
    
      const count = GetAvgRating(courseData?.data?.ratingAndReview);
    
      console.log("kitno n review diya ai->", count);
          ...
          <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
            <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
              ...
              <div className="max-w-[830px] ">
                ...
                {/* Course Details Accordion ye niche wala important wala section wala hai */}
                <div className="py-4">
